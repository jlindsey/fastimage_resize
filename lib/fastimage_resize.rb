...
require 'tempfile'
require 'fastimage'
require 'fastimage_resize_include'

class FastImage
  include FastImageResizeInclude
  ...
  def self.resize(input, w, h, options={})
    ...
    fast_image.resize_image(in_path.to_s, file_out.to_s, w.to_i, h.to_i, type_index.to_i, jpeg_quality.to_i)
